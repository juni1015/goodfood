...
<div id="section">
  <h3>게시글 작성</h3>
  <form action="/board/save" method="post" enctype="multipart/form-data" onsubmit="return save_check()">
    <div class="mb-3">
    ...
    <div class="mb-3">
      ...
      <input type="text" class="form-control" id="store-name" name="boardStoreName" placeholder="가게명 입력" onblur="double_check()">
    </div>
    <div class="mb-3">
      <label for="store-address" class="form-label">주소</label>
      <input type="text" class="form-control" id="store-address" name="boardStoreAddress" placeholder="가게 주소 입력" onblur="double_check()">
      <p id="double-check-result"></p>
    </div>
    <div class="mb-3">
      <label for="store-kind" class="form-label">종류</label>
      <input type="text" class="form-control" id="store-kind" name="boardStoreKind" placeholder="음식 종류 입력">
    </div>
    <div class="mb-3">
      <label for="store-number" class="form-label">전화번호</label>
      <input type="text" class="form-control" id="store-number" name="boardStoreNumber" placeholder="가게 번호 입력" onblur="number_check()">
      <p id="number-check-result"></p>
    </div>
    <div class="mb-3">
      <label for="store-time" class="form-label">영업시간</label>
      <input type="text" class="form-control" id="store-time" name="boardStoreTime" placeholder="가게 영업시간 입력">
    </div>
    <div class="mb-3">
      <label for="store-homepage" class="form-label">홈페이지</label>
      <input type="text" class="form-control" id="store-homepage" name="boardStoreHomepage" placeholder="가게 홈페이지 입력">
    </div>
    <div class="mb-3">
      <label for="profile" class="form-label">이미지 파일</label>
      <input type="file" class="form-control" id="profile" name="boardFile">
    </div>
